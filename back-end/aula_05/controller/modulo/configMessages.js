...
//Mensagens de Sucesso da API
const SUCCESS_CREATED_ITEM_WARNIG  =   {status: true, status_code: 201, message: 'Os dados principais foram inseridos com sucesso, porém alguns apresentaram problemas!'}
...
const SUCCESS_DELETED_ITEM =    {status: true, status_code: 200, message: 'Registro excluído com sucesso!'}
